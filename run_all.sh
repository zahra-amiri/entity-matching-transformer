...
# python ./src/run_training.py --model_type=xlnet --model_name_or_path=xlnet-base-cased --data_processor=DeepMatcherProcessor --data_dir=dirty_amazon_itunes --train_batch_size=16 --eval_batch_size=16 --max_seq_length=180 --num_epochs=15.0 --seed=${SEED}

# cecho "YELLOW" "Start abt_buy xlnet"
# python ./src/run_training.py --model_type=xlnet --model_name_or_path=xlnet-base-cased --data_processor=DeepMatcherProcessor --data_dir=abt_buy --train_batch_size=16 --eval_batch_size=16 --max_seq_length=265 --num_epochs=15.0 --seed=${SEED}

# cecho "YELLOW" "Start dirty_walmart_amazon xlnet"
# python ./src/run_training.py --model_type=xlnet --model_name_or_path=xlnet-base-cased  --data_processor=DeepMatcherProcessor --data_dir=dirty_walmart_amazon --train_batch_size=16 --eval_batch_size=16 --max_seq_length=150 --num_epochs=15.0 --seed=${SEED}

# cecho "YELLOW" "Start dirty_dblp_acm xlnet"
# python ./src/run_training.py --model_type=xlnet --model_name_or_path=xlnet-base-cased  --data_processor=DeepMatcherProcessor --data_dir=dirty_dblp_acm --train_batch_size=16 --eval_batch_size=16 --max_seq_length=180 --num_epochs=15.0 --seed=${SEED}

# cecho "YELLOW" "Start dirty_dblp_scholar xlnet"
# python ./src/run_training.py --model_type=xlnet --model_name_or_path=xlnet-base-cased  --data_processor=DeepMatcherProcessor --data_dir=dirty_dblp_scholar --train_batch_size=16 --eval_batch_size=16 --max_seq_length=128 --num_epochs=15.0 --seed=${SEED}
...
python ./src/run_training.py --model_type=roberta --model_name_or_path=roberta-base --data_processor=DeepMatcherProcessor --data_dir=dirty_walmart_amazon --train_batch_size=16 --eval_batch_size=16 --max_seq_length=150 --num_epochs=15.0 --seed=${SEED}
...
python ./src/run_training.py --model_type=bert --model_name_or_path=pre_trained_model/bert-base-uncased --data_processor=DeepMatcherProcessor --data_dir=dirty_walmart_amazon --train_batch_size=16 --eval_batch_size=16 --max_seq_length=150 --num_epochs=15.0 --seed=${SEED}
